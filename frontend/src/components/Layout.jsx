  ...
  return (
    <div style={{ display:"flex", minHeight:"100vh" }}>
      <aside style={{ width:210, background:"#1e293b", display:"flex", flexDirection:"column", flexShrink:0 }}>
        <div style={{ padding:"24px 20px 16px", fontSize:16, fontWeight:700, color:"#fff", borderBottom:"1px solid #334155" }}>Smart Home</div>
        ...
        <div style={{ padding:"16px 20px", borderTop:"1px solid #334155", fontSize:13, color:"#64748b" }}>{username}</div>
      </aside>
      <div style={{ flex:1, display:"flex", flexDirection:"column" }}>
        <div style={{ background:"#fff", borderBottom:"1px solid #e2e8f0", padding:"0 24px", height:52, display:"flex", alignItems:"center", justifyContent:"flex-end" }}>
          <button onClick={logout} style={{ fontSize:13, padding:"6px 14px", background:"#f1f5f9", border:"1px solid #e2e8f0", borderRadius:6, cursor:"pointer" }}>Log out</button>
        </div>
